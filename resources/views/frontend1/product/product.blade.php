                ...
                <div class="col-md-9">
                    <div class="row mb-4">
                        <div class="col-md-12 d-flex justify-content-between align-items-center">
                            ...
                            <select for="product_category_id"  name="product_category_id">
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="product ftco-animate">
                                <div class=" align-items-center justify-content-center">
                                    ...
                                    <div class="img d-flex align-ir">
                                        <img src="{{asset('uploads/images/product/'.$product->image)}}" alt="" style="height: 100%; width: 100%">
